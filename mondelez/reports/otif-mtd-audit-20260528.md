...
**Window** `2026-05-01` → `2026-05-28` (inclusive) · trục `thoi_gian_gui_thau` (Ngày gửi thầu) · SO filter: `ALL`

- Freshness `thoi_gian_gui_thau`: max_date `2026-05-29 00:00:00`, min_date `2024-05-25 00:00:00`, lag ~226′ vs now (MV refresh 5′ → lag lớn = chưa cập nhật).
...
|---|---:|---:|---:|:--:|
| **% OTIF**   | 20,351   | **91.75%**   | 90% | 🟢 |
| **% Ontime** | 20,558 | **92.68%** | 95% | 🟡 |
| **% Infull** | 21,948 | **98.95%** | 97% | 🟢 |

Tổng đơn (uniqExact SO, đã loại STM-missing): **22,182**
...
| BKD1     |   9990 | 45.04 |      8605 |      86.14 |
| VN831    |    251 |  1.13 |       228 |      90.84 |
...
| metric        |           value |
|:--------------|----------------:|
| plan_cse      |     1.17275e+06 |
| shipped_cse   |     1.17621e+06 |
| delivered_cse |     1.16916e+06 |
| plan_kg       |     4.33923e+06 |
| shipped_kg    |     4.35055e+06 |
| delivered_kg  |     4.32575e+06 |
| plan_cbm      | 41389.5         |
| shipped_cbm   | 41455.4         |
| delivered_cbm | 39542.6         |
