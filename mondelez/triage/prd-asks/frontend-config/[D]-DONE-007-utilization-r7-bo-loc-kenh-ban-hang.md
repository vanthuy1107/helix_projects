# [D]-DONE-007: Bộ lọc "Kênh bán hàng"
...
|---|---|---|---|
| (unknown, before 2026-05-09) | Marked done by MDLZ in Excel | Khách MDLZ | row 7 of `%Utilization (224)` sheet — status `Đã fixed` |
...
(Source: sheet `%Utilization (224)`, row 7, status text `Đã fixed`)
