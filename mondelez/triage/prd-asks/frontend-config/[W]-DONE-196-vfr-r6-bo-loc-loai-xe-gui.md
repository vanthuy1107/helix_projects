# [W]-DONE-196: Bộ lọc "Loại xe gửi thầu"
...
|---|---|---|---|
| 2026-05-09 | Captured during triage as WIP | SLG triage | row 6 of `VFR` sheet — status `Fix lại` |
...
(Source: sheet `VFR`, row 6, status text `Fix lại`)
