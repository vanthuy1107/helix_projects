# [D]-DONE-170: Bộ lọc "Khoảng thời gian"
...
|---|---|---|---|
| (unknown, before 2026-05-09) | Marked done by MDLZ in Excel | Khách MDLZ | row 9 of `VFR (224)` sheet — status `Đã fixed` |
...
(Source: sheet `VFR (224)`, row 9, status text `Đã fixed`)
