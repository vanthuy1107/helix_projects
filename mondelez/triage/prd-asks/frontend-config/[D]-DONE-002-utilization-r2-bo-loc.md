...
|---|---|---|---|
| (unknown, before 2026-05-09) | Marked done by MDLZ in Excel | Khách MDLZ | row 2 of `%Utilization (224)` sheet — status `Đã fixed` |
...
(Source: sheet `%Utilization (224)`, row 2, status text `Đã fixed`)
