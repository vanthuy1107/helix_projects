...
|---|---|---|---|
| (unknown, before 2026-05-09) | Marked done by MDLZ in Excel | Khách MDLZ | row 12 of `VFR` sheet — status `Đã fixed` |
...
(Source: sheet `VFR`, row 12, status text `Đã fixed`)
