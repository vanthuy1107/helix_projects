...
|---|---|---|---|
| (unknown, before 2026-05-09) | Marked done by MDLZ in Excel | Khách MDLZ | row 2 of `Flash report (214)` sheet — status `Đã fixed` |
...
(Source: sheet `Flash report (214)`, row 2, status text `Đã fixed`)
