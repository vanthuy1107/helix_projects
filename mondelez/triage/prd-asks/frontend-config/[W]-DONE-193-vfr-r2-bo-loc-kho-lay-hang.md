# [W]-DONE-193: Bộ lọc "Kho lấy hàng"
...
|---|---|---|---|
| 2026-05-09 | Captured during triage as WIP | SLG triage | row 2 of `VFR` sheet — status `Fix lại` |
...
(Source: sheet `VFR`, row 2, status text `Fix lại`)
