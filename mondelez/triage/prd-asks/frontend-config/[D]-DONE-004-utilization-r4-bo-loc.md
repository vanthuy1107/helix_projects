...
|---|---|---|---|
| (unknown, before 2026-05-09) | Marked done by MDLZ in Excel | Khách MDLZ | row 4 of `%Utilization (224)` sheet — status `Đã fixed` |
...
(Source: sheet `%Utilization (224)`, row 4, status text `Đã fixed`)
