...
|---|---|---|---|
| (unknown, before 2026-05-09) | Marked done by MDLZ in Excel | Khách MDLZ | row 2 of `OTIF (204)` sheet — status `Đã fixed` |
...
(Source: sheet `OTIF (204)`, row 2, status text `Đã fixed`)
