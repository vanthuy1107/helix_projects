# [W]-DONE-198: Bảng dữ liệu detail
...
|---|---|---|---|
| 2026-05-09 | Captured during triage as WIP | SLG triage | row 11 of `VFR` sheet — status `Đang fixing` |
...
(Source: sheet `VFR`, row 11, status text `Đang fixing`)
