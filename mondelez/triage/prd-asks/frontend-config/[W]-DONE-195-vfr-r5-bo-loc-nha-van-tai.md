...
|---|---|---|---|
| 2026-05-09 | Captured during triage as WIP | SLG triage | row 5 of `VFR` sheet — status `Fix lại` |
...
(Source: sheet `VFR`, row 5, status text `Fix lại`)
