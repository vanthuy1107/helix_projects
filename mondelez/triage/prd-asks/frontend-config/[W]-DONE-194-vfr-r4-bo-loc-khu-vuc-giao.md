# [W]-DONE-194: Bộ lọc "Khu vực giao hàng"
...
|---|---|---|---|
| 2026-05-09 | Captured during triage as WIP | SLG triage | row 4 of `VFR` sheet — status `Fix lại` |
...
(Source: sheet `VFR`, row 4, status text `Fix lại`)
