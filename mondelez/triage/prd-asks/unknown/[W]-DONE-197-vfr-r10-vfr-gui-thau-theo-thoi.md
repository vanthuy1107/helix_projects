# [W]-DONE-197: VFR gửi thầu theo thời gian và khu vực
...
|---|---|---|---|
| 2026-05-09 | Captured during triage as WIP | SLG triage | row 10 of `VFR` sheet — status `Fix lại` |
...
(Source: sheet `VFR`, row 10, status text `Fix lại`)
