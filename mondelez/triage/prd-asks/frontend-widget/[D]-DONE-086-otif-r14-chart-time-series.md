...
|---|---|---|---|
| (unknown, before 2026-05-09) | Marked done by MDLZ in Excel | Khách MDLZ | row 14 of `OTIF (204)` sheet — status `Đã fixed` |
...
(Source: sheet `OTIF (204)`, row 14, status text `Đã fixed`)
