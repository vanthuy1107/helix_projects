...
|---|---|---|---|
| (unknown, before 2026-05-09) | Marked done by MDLZ in Excel | Khách MDLZ | row 19 of `Sheet7` sheet — status `Đã sửa=True` |
...
(Source: sheet `Sheet7`, row 19, status text `Đã sửa=True`)
