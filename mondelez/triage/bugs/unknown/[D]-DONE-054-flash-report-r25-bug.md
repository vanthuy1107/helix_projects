...
|---|---|---|---|
| (unknown, before 2026-05-09) | Marked done by MDLZ in Excel | Khách MDLZ | row 25 of `Flash report (214)` sheet — status `Đã fixed` |
...
(Source: sheet `Flash report (214)`, row 25, status text `Đã fixed`)
