...
-- ════════════════════════════════════════════════════
-- Object: .tmp.inner_id.1e98e4ec-1832-4167-ac16-1a5987306b6f  (engine: SharedMergeTree)
-- ════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════
-- Object: mdlz_tms_report_25_trip_order  (engine: SharedMergeTree)
-- ════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════
-- Object: mv_mdlz_tms_report_25_order  (engine: MaterializedView)
-- ════════════════════════════════════════════════════
